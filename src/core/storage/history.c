/*
 * history.c - HTTP request history management (in-memory)
 * 
 * Manages the list of past HTTP requests and responses.
 * Handles adding, retrieving, and trimming history entries.
 * 
 * See history_persistence.c for disk persistence (JSONL format).
 */
